import { Typography,List,ListItem,ListItemText,ListItemAvatar,Box,Avatar} from '@mui/material'
import React from 'react'

export default function InvoiceSent() {
  return (
    <Box sx={{ maxWidth: '350px', minHeight: '411px', }}>
      <Typography color='#333B69' variant='h6' gutterBottom
        sx={{minHeight:'24px'}}                 
        > Invoice Sent
      </Typography>
       <List sx={{ backgroundColor: 'background.paper',borderRadius:4, }}>
            <ListItem>
                ...
                <ListItemText color='#B1B1B1' primary="Apple store" secondary="5h ago" />
                <ListItemText  
                    primary={
                    <Typography color='#718EBF' variant="body2" sx={{ fontSize: '0.875rem' }}>
                        $450
                    </Typography>}/>
            </ListItem>
            ...
            <ListItem>
                <ListItemAvatar>
                <Avatar sx={{ backgroundColor: '#FFE0EB' }}>
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ListItemText color='#B1B1B1' primary="William" secondary="10 days ago" />
                <ListItemText  
                        primary={
                        <Typography color='#718EBF' variant="body2" sx={{ fontSize: '0.875rem' }}>
                            $90
